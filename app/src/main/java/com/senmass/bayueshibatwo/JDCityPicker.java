package com.senmass.bayueshibatwo;
...
public class JDCityPicker extends PopupWindow {
    ...
    public JDCityPicker(Context context, onCitySelect citySelect) throws JSONException {
        super(context);
    ...
    private void init(Context context) throws JSONException {
        ...
        String data =  com.senmass.bayueshibatwo.JsonParser.getJson(context, "city.json");
